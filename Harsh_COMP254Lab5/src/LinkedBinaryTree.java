...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public Position<E> firstInorder() {
    ...
    public void printInorderUsingNext() {
        Position<E> current = firstInorder();
    ...
    ///////2//////
    public int printHeightPostorder(Position<E> p) {
        if (p == null) return -1; //null - no child

        int leftHeight = printHeightPostorder(left(p));
        int rightHeight = printHeightPostorder(right(p));
